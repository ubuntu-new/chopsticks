      ...
      <div class="row">
        <div class="col-lg-4 col-md-12">
          <div class="single-category-box">
            <img
              src="../../assets/img/category-products-img1.jpg"
              alt="image"
            />
        ...
        <div class="col-lg-8 col-md-12">
          <div class="row">
            <div class="col-lg-6 col-md-6">
              <div class="single-category-box">
                <img
                  src="../../assets/img/category-products-img2.jpg"
                  alt="image"
                />
            ...
            <div class="col-lg-6 col-md-6">
              <div class="single-category-box">
                <img
                  src="../../assets/img/category-products-img3.jpg"
                  alt="image"
                />
            ...
            <div class="col-lg-12 col-md-12">
              <div class="single-category-box">
                <img
                  src="../../assets/img/category-products-img4.jpg"
                  alt="image"
                />
